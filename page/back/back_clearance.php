                ...
                <div id="pagination">
                    <ul>
                        <?php
                            ...
                            for($i=1; $i<=$pages; $i++){
                                if( $i == $pageNum ){
                                    echo '<li class="page-item"><a href="back_clearance.php?pageNum='.$i.'" class="page-link nowLoc">'.$i.'</a></li>';
                                }else{
                                    echo '<li class="page-item"><a href="back_clearance.php?pageNum='.$i.'" class="page-link">'.$i.'</a></li>';
                                }
                            }

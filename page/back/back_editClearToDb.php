<?php
    ...
    try {
        ...
        $sql = "update clearanceitem set salePrice = :salePrice, quantity = :quantity where clearanceNo = :clearanceNo and clearItemNo = 1";
        ...
        $clearItems -> execute();
        $sql = "update clearanceitem set salePrice = :salePrice, quantity = :quantity where clearanceNo = :clearanceNo and clearItemNo = 2";
        $clearItems = $pdo -> prepare($sql);
        $clearItems -> bindValue(':clearanceNo', $_REQUEST['clearanceNo']);
        $clearItems -> bindValue(':salePrice', $_REQUEST['item2Price']);
        $clearItems -> bindValue(':quantity', $_REQUEST['item2Qty']);
        $clearItems -> execute();
        $sql = "update clearanceitem set salePrice = :salePrice, quantity = :quantity where clearanceNo = :clearanceNo and clearItemNo = 3";
        $clearItems = $pdo -> prepare($sql);
        $clearItems -> bindValue(':clearanceNo', $_REQUEST['clearanceNo']);

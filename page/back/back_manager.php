                ...
                <div id="pagination">
                    <ul>
                        <?php
                            ...
                            for($i=1; $i<=$pages; $i++){
                                if( $i == $pageNum ){
                                    echo '<li class="page-item"><a href="back_manager.php?pageNum='.$i.'" class="page-link nowLoc">0'.$i.'</a></li>';
                                }else{
                                    echo '<li class="page-item"><a href="back_manager.php?pageNum='.$i.'" class="page-link">0'.$i.'</a></li>';
                                }
                            }

        ...
        <form action="" method="post" enctype="multipart/form-data">
            <table class="col-12 col-1">
                <tr>
                    <td>
                        <div>
                            <img src="../images/tina/大頭貼.png" alt="level">
                        </div>
            ...
            <table class="col-12 col-2">
                ...
                <tr>
                    <td>
                        <p>
                            電話：
                            <input type="number" name="phone" value="0911664587" maxlength="10">
                            <img src="../images/tina/pen.png" alt="編輯">
                        </p>
                    </td>
                </tr>
                <tr>
                    <td>
                        <p>
                            信箱：
                            <input type="email" name="email" value="aa12345@gmail.com" maxlength="20">
                            <img src="../images/tina/pen.png" alt="編輯">
                        </p>
                    </td>
                </tr>

                        ...
                        <div class="orderLis_content">
                            <table class="orderList_items">
                                ...
                                <tr class="orderList_moreItems item01">
                                    ...
                                    <td><?php echo $order_listArr[$i]['snackName'] ?>
                                    </td>
                                    <td><?php echo $order_listArr[$i]['snackQuan'] ?>
                                    </td>
                                    <td><?php echo $order_listArr[$i]['snackPrice'] ?>
                                    </td>
                                    <td><?php echo $order_listArr[$i]['snackQuan'] *$order_listArr[$i]['snackPrice']?>
                                    </td>
                                    <td>一般</td>
                                    <td>
                                ...
                                <tr class="eva_lightBox_Box01 eva_lightBox" style="display: none;" name="snackNo <?php echo $order_listArr[$i]['snackNo'] ?>">
                                    <td>
                                            ...
                                            <li>
                                                <p>甜度：
                                                    <ul class="eva_lightBox_swStars">
                                                        <li>1星 <input type="radio" name="swStar" value="1">
                                                        </li>
                                                        <li>2星 <input type="radio" name="swStar" value="2">
                                                        </li>
                                                        <li>3星 <input type="radio" name="swStar" value="3">
                                                        </li>
                                                        <li>4星 <input type="radio" name="swStar" value="4">
                                                        </li>
                                                        <li>5星 <input type="radio" name="swStar" value="5">
                                                        </li>
                                                    </ul>
                                                </p>
                                            </li>
                                            <li>
                                                <p>酸度：
                                                    <ul class="eva_lightBox_suStars">
                                                        <li>1星 <input type="radio" name="suStar" value="1">
                                                        </li>
                                                        <li>2星 <input type="radio" name="suStar" value="2">
                                                        </li>
                                                        <li>3星 <input type="radio" name="suStar" value="3">
                                                        </li>
                                                        <li>4星 <input type="radio" name="suStar" value="4">
                                                        </li>
                                                        <li>5星 <input type="radio" name="suStar" value="5">
                                                        </li>
                                                    </ul>
                                                </p>
                                            </li>
                                            <li>
                                                <p>辣度：
                                                    <ul class="eva_lightBox_spStars">
                                                        <li>1星 <input type="radio" name="spStar" value="1">
                                                        </li>
                                                        <li>2星 <input type="radio" name="spStar" value="2">
                                                        </li>
                                                        <li>3星 <input type="radio" name="spStar" value="3">
                                                        </li>
                                                        <li>4星 <input type="radio" name="spStar" value="4">
                                                        </li>
                                                        <li>5星 <input type="radio" name="spStar" value="5">
                                                        </li>
                                                    </ul>
                                                </p>
                                            </li>
                                            <li>
                                                <p>好評度：
                                                    <ul class="eva_lightBox_gdStars">
                                                        <li>1星 <input type="radio" name="gdStar" value="1">
                                                        </li>
                                                        <li>2星 <input type="radio" name="gdStar" value="2">
                                                        </li>
                                                        <li>3星 <input type="radio" name="gdStar" value="3">
                                                        </li>
                                                        <li>4星 <input type="radio" name="gdStar" value="4">
                                                        </li>
                                                        <li>5星 <input type="radio" name="gdStar" value="5">
                                                        </li>
                                                    </ul>
                                                </p>
                                            </li>
                                    ...
                                    <td>
                                        <p>留言分享</p>
                                        <textarea name="textDiscuss" cols="50" rows="10" class="eva_lightBox_textDics"></textarea>
                                    </td>
                                    <td>
